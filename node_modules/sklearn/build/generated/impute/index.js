...
ctor_IterativeImputer = {k: v for k, v in ctor_IterativeImputer.items() if v is not None}`;
  ...
  async fit(opts) {
    ...
    await this._py.ex`pms_IterativeImputer_fit = {'X': ${opts["X"] ?? void 0}, 'y': ${opts["y"] ?? void 0}, 'fit_params': ${opts["fit_params"] ?? void 0}}
...
pms_IterativeImputer_fit = {k: v for k, v in pms_IterativeImputer_fit.items() if v is not None}`;
  ...
  async fit_transform(opts) {
    ...
    await this._py.ex`pms_IterativeImputer_fit_transform = {'X': ${opts["X"] ?? void 0}, 'y': ${opts["y"] ?? void 0}, 'params': ${opts["params"] ?? void 0}}
...
var KNNImputer = class {
  ...
  _isDisposed = false;
  constructor(opts) {
    this.id = `KNNImputer${crypto2.randomUUID().split("-")[0]}`;
    this.opts = opts || {};
  }
  get py() {
    return this._py;
...
var MissingIndicator = class {
  ...
  _isDisposed = false;
  constructor(opts) {
    this.id = `MissingIndicator${crypto3.randomUUID().split("-")[0]}`;
    this.opts = opts || {};
  }
  get py() {
    return this._py;
...
var SimpleImputer = class {
  ...
  _isDisposed = false;
  constructor(opts) {
    this.id = `SimpleImputer${crypto4.randomUUID().split("-")[0]}`;
    this.opts = opts || {};
  }
  get py() {
    return this._py;
