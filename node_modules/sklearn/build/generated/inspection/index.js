...
var PartialDependenceDisplay = class {
  ...
  _isDisposed = false;
  constructor(opts) {
    this.id = `PartialDependenceDisplay${crypto2.randomUUID().split("-")[0]}`;
    this.opts = opts || {};
  }
  get py() {
    return this._py;
