...
`;
    await this._py.ex`ctor_FeatureUnion = {'transformer_list': ${this.opts["transformer_list"] ?? void 0}, 'n_jobs': ${this.opts["n_jobs"] ?? void 0}, 'transformer_weights': ${this.opts["transformer_weights"] ?? void 0}, 'verbose': ${this.opts["verbose"] ?? void 0}, 'verbose_feature_names_out': ${this.opts["verbose_feature_names_out"] ?? void 0}}
...
pms_FeatureUnion_fit = {k: v for k, v in pms_FeatureUnion_fit.items() if v is not None}`;
  ...
  async fit_transform(opts) {
    ...
    await this._py.ex`pms_FeatureUnion_fit_transform = {'X': ${opts["X"] ?? void 0}, 'y': np.array(${opts["y"] ?? void 0}) if ${opts["y"] !== void 0} else None, 'params': ${opts["params"] ?? void 0}}
...
pms_FeatureUnion_set_output = {k: v for k, v in pms_FeatureUnion_set_output.items() if v is not None}`;
  ...
  async transform(opts) {
    ...
    await this._py.ex`pms_FeatureUnion_transform = {'X': ${opts["X"] ?? void 0}, 'params': ${opts["params"] ?? void 0}}
...
var Pipeline = class {
  ...
  _isDisposed = false;
  constructor(opts) {
    this.id = `Pipeline${crypto2.randomUUID().split("-")[0]}`;
    this.opts = opts || {};
  }
  get py() {
    return this._py;
...
ctor_Pipeline = {k: v for k, v in ctor_Pipeline.items() if v is not None}`;
  ...
  async decision_function(opts) {
    ...
    await this._py.ex`pms_Pipeline_decision_function = {'X': ${opts["X"] ?? void 0}, 'params': ${opts["params"] ?? void 0}}
...
pms_Pipeline_decision_function = {k: v for k, v in pms_Pipeline_decision_function.items() if v is not None}`;
  ...
  async fit(opts) {
    ...
    await this._py.ex`pms_Pipeline_fit = {'X': ${opts["X"] ?? void 0}, 'y': ${opts["y"] ?? void 0}, 'params': ${opts["params"] ?? void 0}}
...
pms_Pipeline_fit = {k: v for k, v in pms_Pipeline_fit.items() if v is not None}`;
  ...
  async fit_predict(opts) {
    ...
    await this._py.ex`pms_Pipeline_fit_predict = {'X': ${opts["X"] ?? void 0}, 'y': ${opts["y"] ?? void 0}, 'params': ${opts["params"] ?? void 0}}
...
pms_Pipeline_fit_predict = {k: v for k, v in pms_Pipeline_fit_predict.items() if v is not None}`;
  ...
  async fit_transform(opts) {
    ...
    await this._py.ex`pms_Pipeline_fit_transform = {'X': ${opts["X"] ?? void 0}, 'y': ${opts["y"] ?? void 0}, 'params': ${opts["params"] ?? void 0}}
...
pms_Pipeline_get_metadata_routing = {k: v for k, v in pms_Pipeline_get_metadata_routing.items() if v is not None}`;
  ...
  async inverse_transform(opts) {
    ...
    await this._py.ex`pms_Pipeline_inverse_transform = {'X': np.array(${opts["X"] ?? void 0}) if ${opts["X"] !== void 0} else None, 'Xt': np.array(${opts["Xt"] ?? void 0}) if ${opts["Xt"] !== void 0} else None, 'params': ${opts["params"] ?? void 0}}
...
pms_Pipeline_inverse_transform = {k: v for k, v in pms_Pipeline_inverse_transform.items() if v is not None}`;
  ...
  async predict(opts) {
    ...
    await this._py.ex`pms_Pipeline_predict = {'X': ${opts["X"] ?? void 0}, 'params': ${opts["params"] ?? void 0}}
...
pms_Pipeline_predict = {k: v for k, v in pms_Pipeline_predict.items() if v is not None}`;
  ...
  async predict_log_proba(opts) {
    ...
    await this._py.ex`pms_Pipeline_predict_log_proba = {'X': ${opts["X"] ?? void 0}, 'params': ${opts["params"] ?? void 0}}
...
pms_Pipeline_predict_log_proba = {k: v for k, v in pms_Pipeline_predict_log_proba.items() if v is not None}`;
  ...
  async predict_proba(opts) {
    ...
    await this._py.ex`pms_Pipeline_predict_proba = {'X': ${opts["X"] ?? void 0}, 'params': ${opts["params"] ?? void 0}}
...
pms_Pipeline_predict_proba = {k: v for k, v in pms_Pipeline_predict_proba.items() if v is not None}`;
  ...
  async score(opts) {
    ...
    await this._py.ex`pms_Pipeline_score = {'X': ${opts["X"] ?? void 0}, 'y': ${opts["y"] ?? void 0}, 'sample_weight': ${opts["sample_weight"] ?? void 0}, 'params': ${opts["params"] ?? void 0}}
...
pms_Pipeline_set_score_request = {k: v for k, v in pms_Pipeline_set_score_request.items() if v is not None}`;
  ...
  async transform(opts) {
    ...
    await this._py.ex`pms_Pipeline_transform = {'X': ${opts["X"] ?? void 0}, 'params': ${opts["params"] ?? void 0}}
