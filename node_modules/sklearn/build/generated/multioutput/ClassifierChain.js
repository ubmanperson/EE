...
`;
    await this._py.ex`ctor_ClassifierChain = {'base_estimator': ${this.opts["base_estimator"] ?? void 0}, 'order': np.array(${this.opts["order"] ?? void 0}) if ${this.opts["order"] !== void 0} else None, 'cv': ${this.opts["cv"] ?? void 0}, 'chain_method': ${this.opts["chain_method"] ?? void 0}, 'random_state': ${this.opts["random_state"] ?? void 0}, 'verbose': ${this.opts["verbose"] ?? void 0}}
...
pms_ClassifierChain_predict = {k: v for k, v in pms_ClassifierChain_predict.items() if v is not None}`;
  ...
  async predict_log_proba(opts) {
    ...
    await this._py.ex`pms_ClassifierChain_predict_log_proba = {'X': np.array(${opts["X"] ?? void 0}) if ${opts["X"] !== void 0} else None}

pms_ClassifierChain_predict_log_proba = {k: v for k, v in pms_ClassifierChain_predict_log_proba.items() if v is not None}`;
    await this._py.ex`res_ClassifierChain_predict_log_proba = bridgeClassifierChain[${this.id}].predict_log_proba(**pms_ClassifierChain_predict_log_proba)`;
    return this._py`res_ClassifierChain_predict_log_proba.tolist() if hasattr(res_ClassifierChain_predict_log_proba, 'tolist') else res_ClassifierChain_predict_log_proba`;
  }
  /**
...
pms_ClassifierChain_set_score_request = {k: v for k, v in pms_ClassifierChain_set_score_request.items() if v is not None}`;
  ...
  get chain_method_() {
    ...
    return (async () => {
      await this._py.ex`attr_ClassifierChain_chain_method_ = bridgeClassifierChain[${this.id}].chain_method_`;
      return this._py`attr_ClassifierChain_chain_method_.tolist() if hasattr(attr_ClassifierChain_chain_method_, 'tolist') else attr_ClassifierChain_chain_method_`;
    })();
  }
  /**
...
//# sourceMappingURL=ClassifierChain.js.map