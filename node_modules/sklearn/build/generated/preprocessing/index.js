...
pms_KBinsDiscretizer_get_metadata_routing = {k: v for k, v in pms_KBinsDiscretizer_get_metadata_routing.items() if v is not None}`;
  ...
  async inverse_transform(opts) {
    ...
    await this._py.ex`pms_KBinsDiscretizer_inverse_transform = {'X': np.array(${opts["X"] ?? void 0}) if ${opts["X"] !== void 0} else None, 'Xt': np.array(${opts["Xt"] ?? void 0}) if ${opts["Xt"] !== void 0} else None}
...
`;
    await this._py.ex`ctor_OneHotEncoder = {'categories': ${this.opts["categories"] ?? void 0}, 'drop': np.array(${this.opts["drop"] ?? void 0}) if ${this.opts["drop"] !== void 0} else None, 'sparse_output': ${this.opts["sparse_output"] ?? void 0}, 'dtype': ${this.opts["dtype"] ?? void 0}, 'handle_unknown': ${this.opts["handle_unknown"] ?? void 0}, 'min_frequency': ${this.opts["min_frequency"] ?? void 0}, 'max_categories': ${this.opts["max_categories"] ?? void 0}, 'feature_name_combiner': ${this.opts["feature_name_combiner"] ?? void 0}}
...
pms_TargetEncoder_transform = {k: v for k, v in pms_TargetEncoder_transform.items() if v is not None}`;
  ...
  get classes_() {
    ...
    return (async () => {
      await this._py.ex`attr_TargetEncoder_classes_ = bridgeTargetEncoder[${this.id}].classes_`;
      return this._py`attr_TargetEncoder_classes_.tolist() if hasattr(attr_TargetEncoder_classes_, 'tolist') else attr_TargetEncoder_classes_`;
    })();
  }
};
export {
