...
var FeatureHasher = class {
  ...
  _isDisposed = false;
  constructor(opts) {
    this.id = `FeatureHasher${crypto2.randomUUID().split("-")[0]}`;
    this.opts = opts || {};
  }
  get py() {
    return this._py;
...
var PatchExtractor = class {
  ...
  _isDisposed = false;
  constructor(opts) {
    this.id = `PatchExtractor${crypto3.randomUUID().split("-")[0]}`;
    this.opts = opts || {};
  }
  get py() {
    return this._py;
...
var CountVectorizer = class {
  ...
  _isDisposed = false;
  constructor(opts) {
    this.id = `CountVectorizer${crypto4.randomUUID().split("-")[0]}`;
    this.opts = opts || {};
  }
  get py() {
    return this._py;
...
var HashingVectorizer = class {
  ...
  _isDisposed = false;
  constructor(opts) {
    this.id = `HashingVectorizer${crypto5.randomUUID().split("-")[0]}`;
    this.opts = opts || {};
  }
  get py() {
    return this._py;
...
var TfidfTransformer = class {
  ...
  _isDisposed = false;
  constructor(opts) {
    this.id = `TfidfTransformer${crypto6.randomUUID().split("-")[0]}`;
    this.opts = opts || {};
  }
  get py() {
    return this._py;
...
pms_TfidfTransformer_transform = {k: v for k, v in pms_TfidfTransformer_transform.items() if v is not None}`;
  ...
  get idf_() {
    ...
    return (async () => {
      await this._py.ex`attr_TfidfTransformer_idf_ = bridgeTfidfTransformer[${this.id}].idf_`;
      return this._py`attr_TfidfTransformer_idf_.tolist() if hasattr(attr_TfidfTransformer_idf_, 'tolist') else attr_TfidfTransformer_idf_`;
    })();
  }
  /**
...
var TfidfVectorizer = class {
  ...
  _isDisposed = false;
  constructor(opts) {
    this.id = `TfidfVectorizer${crypto7.randomUUID().split("-")[0]}`;
    this.opts = opts || {};
  }
  get py() {
    return this._py;
